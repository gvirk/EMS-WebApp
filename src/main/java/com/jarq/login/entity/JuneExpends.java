...
@Entity
@Table(name = "1_june_2018")
public class JuneExpends {
	...
	public JuneExpends(int id, String date, double eating, double mobile, double flat, double fuel, double tickets,
