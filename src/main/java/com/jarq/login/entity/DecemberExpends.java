...
@Entity
@Table(name = "1_december_2018")
public class DecemberExpends {
	...
	public DecemberExpends() {
	}

	public DecemberExpends(int id, String date, double eating, double mobile, double flat, double fuel, double tickets,
