...
@Entity
@Table(name = "1_february_2018")
public class FebruaryExpends {
	...
	public FebruaryExpends() {
	}

	public FebruaryExpends(int id, String date, double eating, double mobile, double flat, double fuel, double tickets,
