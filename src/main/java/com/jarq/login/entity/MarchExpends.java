...
@Entity
@Table(name = "1_march_2018")
public class MarchExpends {
	...
	public MarchExpends(int id, String date, double eating, double mobile, double flat, double fuel, double tickets,
