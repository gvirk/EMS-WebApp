...
@Entity
@Table(name = "1_january_2018")
public class JanuaryExpends {
	...
	public JanuaryExpends() {
	}

	public JanuaryExpends(int id, String date, double eating, double mobile, double flat, double fuel, double tickets,
