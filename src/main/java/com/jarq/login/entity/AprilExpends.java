...
@Entity
@Table(name = "1_april_2018")
public class AprilExpends {
	...
	public AprilExpends(int id, String date, double eating, double mobile, double flat, double fuel, double tickets,
