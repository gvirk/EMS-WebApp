...
@Entity
@Table(name = "1_july_2018")
public class JulyExpends {
	...
	public JulyExpends(int id, String date, double eating, double mobile, double flat, double fuel, double tickets,
