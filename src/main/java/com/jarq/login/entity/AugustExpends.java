...
@Entity
@Table(name = "1_august_2018")
public class AugustExpends {
	...
	public AugustExpends() {
	}

	public AugustExpends(int id, String date, double eating, double mobile, double flat, double fuel, double tickets,
