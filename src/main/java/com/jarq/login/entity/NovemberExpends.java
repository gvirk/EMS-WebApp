...
@Entity
@Table(name = "1_november_2018")
public class NovemberExpends {
	...
	public NovemberExpends() {
	}

	public NovemberExpends(int id, String date, double eating, double mobile, double flat, double fuel, double tickets,
