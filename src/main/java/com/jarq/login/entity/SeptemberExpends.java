...
@Entity
@Table(name = "1_september_2018")
public class SeptemberExpends {
	...
	public SeptemberExpends() {
	}

	public SeptemberExpends(int id, String date, double eating, double mobile, double flat, double fuel, double tickets,
